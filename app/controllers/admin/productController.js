...
exports.getProductByIdController = async (req, res) => {
  try {
    ...
    return res
      .status(getProductByIdService.status)
      .json(getProductByIdService.data);
  } catch (error) {
...
exports.updateProductController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Something went wrong please try again (updateProduct)" });
  }
};
...
exports.deleteProductController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Something went wrong please try again (deleteProduct)" });
  }
};
