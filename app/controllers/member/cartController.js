...
const Cart = require("../../models/member/cartModel");
const User = require("../../models/auth/userModel");
const Product = require("../../models/admin/productModel");
const { AddBookingHistory } = require("../../services/member/cartService");
...
exports.addCart = async (req, res) => {
  ...
  try {
    ...
    logger.error("addCart Error:", error);
...
exports.GetOrderHistory = async (req, res) => {
  try {
    ...
    logger.error("GetOrderHistory Error:", error);
    res.status(500).json({
