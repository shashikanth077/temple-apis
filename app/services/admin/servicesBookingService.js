...
const God = require("../../models/admin/godModel");
const User = require("../../models/auth/userModel");
const ServiceHistory = require("../../models/member/bookingHistory/serviceHistoryModel");
...
const createBookings = async (req, res) => {
  ...
  if (req.body.transStatus === "succeeded") {
    message =
      "Payment was successfull. Thank you for booking " + req.body.ServiceName;
  } else {
    message =
